...
public class WageController {
  ...
  public WageDto createWage(@RequestParam("tutorId") Integer tutorId, @RequestParam("course") String courseName,
      @RequestParam("wage") Integer wageAmount) throws IllegalArgumentException {
